 ...
 */
export function CustomerFormPanel({ owners, brands, customer, triggerLabel, variant = 'primary' }: {
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              <div className="flex items-end pb-1">
                <Checkbox
                  ...
                  label="Happy to receive marketing"
                  hint="Recorded with the date, because consent without one is not consent."
                  defaultChecked={customer?.marketingConsent}
                />
              </div>
              <Note name="notes" label="Notes" placeholder="What they collect, how they like to be dealt with."
