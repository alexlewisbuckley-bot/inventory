    ...
    <WatchDrawerClient
      record={{
        ...
        checks: watchChecks({
          ...
          directorName: record.supplier.directorName,
          idCheckStatus: record.supplier.idCheckStatus,
          idCheckedAt: record.supplier.idCheckedAt,
          idDocumentExpiresOn: record.supplier.idDocumentExpiresOn,
          serial: record.watch.serial,
